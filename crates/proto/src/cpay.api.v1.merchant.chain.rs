        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/cpay.api.v1.merchant.chain.ChainService/ListChains",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "cpay.api.v1.merchant.chain.ChainService",
                        "ListChains",
                    ),
                );
...
pub mod chain_service_server {
    ...
    pub const SERVICE_NAME: &str = "cpay.api.v1.merchant.chain.ChainService";
