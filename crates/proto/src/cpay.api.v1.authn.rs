...
impl AuthProvider {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "AUTH_PROVIDER_GOOGLE" => Some(Self::Google),
            _ => None,
        }
    }
}
...
pub struct InitAuthRequest {
    #[prost(oneof = "init_auth_request::Method", tags = "1, 2")]
    pub method: ::core::option::Option<init_auth_request::Method>,
}
/// Nested message and enum types in `InitAuthRequest`.
pub mod init_auth_request {
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum Method {
        #[prost(message, tag = "1")]
        Provider(super::ProviderMethod),
        #[prost(message, tag = "2")]
        Email(super::EmailMethod),
    }
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ProviderMethod {
    #[prost(enumeration = "AuthProvider", tag = "1")]
    pub provider: i32,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct InitAuthResponse {
    #[prost(oneof = "init_auth_response::Continuation", tags = "1")]
    pub continuation: ::core::option::Option<init_auth_response::Continuation>,
}
/// Nested message and enum types in `InitAuthResponse`.
...
pub mod authn_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn init_auth(
            &mut self,
            request: impl tonic::IntoRequest<super::InitAuthRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/cpay.api.v1.authn.AuthnService/InitAuth",
            );
...
pub mod authn_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/cpay.api.v1.authn.AuthnService/InitAuth" => {
                    ...
                    struct InitAuthSvc<T: AuthnService>(pub Arc<T>);
                    impl<
                        T: AuthnService,
                    > tonic::server::UnaryService<super::InitAuthRequest>
                    for InitAuthSvc<T> {
                        type Response = super::InitAuthResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AuthnService>::init_auth(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "cpay.api.v1.authn.AuthnService";
